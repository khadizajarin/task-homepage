        ...
        <div className="hero bg-[#FFFFFF] flex justify-center relative" style ={{height: '90vh'}}  >
            ...
            <div className="hero-content text-center lg:py-28">
                <div className="">
                    ...
                    <h1 className="mb-10 lg:text-6xl text-5xl font-extrabold text-[#333535] leading-tight"><span className=" text-[#048F8F]">Calendly</span> For The Work You Do</h1>
                    <p className="mb-10 text-[#6D6D6D] font-medium lg:text-2xl text-lg px-6 leading-relaxed tracking-wider">Across arange of uses, Calendly helps people and teams build efficiency, <br />
